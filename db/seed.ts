	...
	await db.insert(Sponsor).values([
		{
			...
			name: "Nike, Inc.",
			address: "USA",
			description: "Nike, Inc. is an American athletic footwear and apparel corporation headquartered near Beaverton, Oregon, United States.",
			email: "nike@gmail.com",
			image: "https://res.cloudinary.com/dmubfrefi/image/private/s--X0LLoOBX--/c_crop,h_2728,w_4090,x_334,y_0/f_auto/q_auto/v1/dee-about-cms-prod-medias/cf68f541-fc92-4373-91cb-086ae0fe2f88/002-nike-logos-swoosh-white.jpg?_a=BAAAROBs",
			idCategory: 5,
			idUser: 2,
		...
		},
		{
			...
			address: "Krikilan",
			description: "Rumah sakit yang ada di krikilan",
